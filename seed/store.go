...
func (s *Seeder) SeedInitialStoreItems(ctx context.Context, passportURL string) error {
	...
	initialStoreItems := []*passport.StoreItem{
		...
		{Name: "Boston Cybernetics Law Enforcer X-1000 Dynamic Yellow", FactionID: passport.BostonCyberneticsFactionID, CollectionID: supremacyCollection.ID, Description: "Dynamic Yellow", UsdCentCost: 100000, AmountAvailable: 100000, SoldBefore: time.Date(2022, 03, 01, 0, 0, 0, 0, time.UTC), Attributes: []*passport.Attribute{{TraitType: "Brand", Value: "Boston Cybernetics"}, {TraitType: "Model", Value: "Law Enforcer X-1000"}, {TraitType: "SubModel", Value: "Dynamic Yellow"}, {TraitType: "Rarity", Value: "Legendary"}, {TraitType: "Asset Type", Value: "War Machine"}, {TraitType: "Max Structure Hit Points", Value: 1000, DisplayType: passport.Number}, {TraitType: "Max Shield Hit Points", Value: 1000, DisplayType: passport.Number}}},
		{Name: "Boston Cybernetics Law Enforcer X-1000 Molten", FactionID: passport.BostonCyberneticsFactionID, CollectionID: supremacyCollection.ID, Description: "Molten", UsdCentCost: 100000, AmountAvailable: 100000, SoldBefore: time.Date(2022, 03, 01, 0, 0, 0, 0, time.UTC), Attributes: []*passport.Attribute{{TraitType: "Brand", Value: "Boston Cybernetics"}, {TraitType: "Model", Value: "Law Enforcer X-1000"}, {TraitType: "SubModel", Value: "Molten"}, {TraitType: "Rarity", Value: "Legendary"}, {TraitType: "Asset Type", Value: "War Machine"}, {TraitType: "Max Structure Hit Points", Value: 1000, DisplayType: passport.Number}, {TraitType: "Max Shield Hit Points", Value: 1000, DisplayType: passport.Number}}},
		{Name: "Boston Cybernetics Law Enforcer X-1000 Mystermech", FactionID: passport.BostonCyberneticsFactionID, CollectionID: supremacyCollection.ID, Description: "Mystermech", UsdCentCost: 100000, AmountAvailable: 100000, SoldBefore: time.Date(2022, 03, 01, 0, 0, 0, 0, time.UTC), Attributes: []*passport.Attribute{{TraitType: "Brand", Value: "Boston Cybernetics"}, {TraitType: "Model", Value: "Law Enforcer X-1000"}, {TraitType: "SubModel", Value: "Mystermech"}, {TraitType: "Rarity", Value: "Legendary"}, {TraitType: "Asset Type", Value: "War Machine"}, {TraitType: "Max Structure Hit Points", Value: 1000, DisplayType: passport.Number}, {TraitType: "Max Shield Hit Points", Value: 1000, DisplayType: passport.Number}}},
		{Name: "Boston Cybernetics Law Enforcer X-1000 Nebula", FactionID: passport.BostonCyberneticsFactionID, CollectionID: supremacyCollection.ID, Description: "Nebula", UsdCentCost: 100000, AmountAvailable: 100000, SoldBefore: time.Date(2022, 03, 01, 0, 0, 0, 0, time.UTC), Attributes: []*passport.Attribute{{TraitType: "Brand", Value: "Boston Cybernetics"}, {TraitType: "Model", Value: "Law Enforcer X-1000"}, {TraitType: "SubModel", Value: "Nebula"}, {TraitType: "Rarity", Value: "Legendary"}, {TraitType: "Asset Type", Value: "War Machine"}, {TraitType: "Max Structure Hit Points", Value: 1000, DisplayType: passport.Number}, {TraitType: "Max Shield Hit Points", Value: 1000, DisplayType: passport.Number}}},
		{Name: "Boston Cybernetics Law Enforcer X-1000 Sleek", FactionID: passport.BostonCyberneticsFactionID, CollectionID: supremacyCollection.ID, Description: "Sleek", UsdCentCost: 100000, AmountAvailable: 100000, SoldBefore: time.Date(2022, 03, 01, 0, 0, 0, 0, time.UTC), Attributes: []*passport.Attribute{{TraitType: "Brand", Value: "Boston Cybernetics"}, {TraitType: "Model", Value: "Law Enforcer X-1000"}, {TraitType: "SubModel", Value: "Sleek"}, {TraitType: "Rarity", Value: "Legendary"}, {TraitType: "Asset Type", Value: "War Machine"}, {TraitType: "Max Structure Hit Points", Value: 1000, DisplayType: passport.Number}, {TraitType: "Max Shield Hit Points", Value: 1000, DisplayType: passport.Number}}},
		{Name: "Boston Cybernetics Law Enforcer X-1000 Vintage", FactionID: passport.BostonCyberneticsFactionID, CollectionID: supremacyCollection.ID, Description: "Vintage", UsdCentCost: 100000, AmountAvailable: 100000, SoldBefore: time.Date(2022, 03, 01, 0, 0, 0, 0, time.UTC), Attributes: []*passport.Attribute{{TraitType: "Brand", Value: "Boston Cybernetics"}, {TraitType: "Model", Value: "Law Enforcer X-1000"}, {TraitType: "SubModel", Value: "Vintage"}, {TraitType: "Rarity", Value: "Legendary"}, {TraitType: "Asset Type", Value: "War Machine"}, {TraitType: "Max Structure Hit Points", Value: 1000, DisplayType: passport.Number}, {TraitType: "Max Shield Hit Points", Value: 1000, DisplayType: passport.Number}}},
		{Name: "Boston Cybernetics Law Enforcer X-1000 White Blue", FactionID: passport.BostonCyberneticsFactionID, CollectionID: supremacyCollection.ID, Description: "White Blue", UsdCentCost: 100000, AmountAvailable: 100000, SoldBefore: time.Date(2022, 03, 01, 0, 0, 0, 0, time.UTC), Attributes: []*passport.Attribute{{TraitType: "Brand", Value: "Boston Cybernetics"}, {TraitType: "Model", Value: "Law Enforcer X-1000"}, {TraitType: "SubModel", Value: "White Blue"}, {TraitType: "Rarity", Value: "Legendary"}, {TraitType: "Asset Type", Value: "War Machine"}, {TraitType: "Max Structure Hit Points", Value: 1000, DisplayType: passport.Number}, {TraitType: "Max Shield Hit Points", Value: 1000, DisplayType: passport.Number}}},
	}
	...
	for _, si := range initialStoreItems {
		...
		name := fmt.Sprintf("%s %s %s", si.Attributes[0].Value, si.Attributes[1].Value, si.Attributes[2].Value)
		si.AnimationURL = ""
		...
		nameAttribute := &passport.Attribute{Value: name, TraitType: "Name"}
		si.Attributes = append(si.Attributes, nameAttribute)
		switch si.FactionID {
