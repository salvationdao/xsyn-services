...
func (s *Seeder) SeedInitialStoreItems(ctx context.Context, passportURL string) error {
	...
	initialStoreItems := []*passport.StoreItem{
		...
		{Restriction: "", Name: "", FactionID: passport.BostonCyberneticsFactionID, CollectionID: supremacyCollection.ID, Description: "Rust Bucket", UsdCentCost: 100000, AmountAvailable: 500, SoldBefore: time.Date(2022, 03, 01, 0, 0, 0, 0, time.UTC), Attributes: []*passport.Attribute{{TraitType: "Brand", Value: "Boston Cybernetics"}, {TraitType: "Model", Value: "Law Enforcer X-1000"}, {TraitType: "SubModel", Value: "Rust Bucket"}, {TraitType: "Rarity", Value: "Mega"}, {TraitType: "Asset Type", Value: "War Machine"}, {TraitType: "Max Structure Hit Points", Value: 1000, DisplayType: passport.Number}, {TraitType: "Max Shield Hit Points", Value: 1000, DisplayType: passport.Number}}},
		{Restriction: "", Name: "", FactionID: passport.BostonCyberneticsFactionID, CollectionID: supremacyCollection.ID, Description: "Dune", UsdCentCost: 100000, AmountAvailable: 500, SoldBefore: time.Date(2022, 03, 01, 0, 0, 0, 0, time.UTC), Attributes: []*passport.Attribute{{TraitType: "Brand", Value: "Boston Cybernetics"}, {TraitType: "Model", Value: "Law Enforcer X-1000"}, {TraitType: "SubModel", Value: "Dune"}, {TraitType: "Rarity", Value: "Mega"}, {TraitType: "Asset Type", Value: "War Machine"}, {TraitType: "Max Structure Hit Points", Value: 1000, DisplayType: passport.Number}, {TraitType: "Max Shield Hit Points", Value: 1000, DisplayType: passport.Number}}},
		...
		{Restriction: "", Name: "", FactionID: passport.BostonCyberneticsFactionID, CollectionID: supremacyCollection.ID, Description: "Vintage", UsdCentCost: 100000, AmountAvailable: 500, SoldBefore: time.Date(2022, 03, 01, 0, 0, 0, 0, time.UTC), Attributes: []*passport.Attribute{{TraitType: "Brand", Value: "Boston Cybernetics"}, {TraitType: "Model", Value: "Law Enforcer X-1000"}, {TraitType: "SubModel", Value: "Vintage"}, {TraitType: "Rarity", Value: "Mega"}, {TraitType: "Asset Type", Value: "War Machine"}, {TraitType: "Max Structure Hit Points", Value: 1000, DisplayType: passport.Number}, {TraitType: "Max Shield Hit Points", Value: 1000, DisplayType: passport.Number}}},
		...
		{Restriction: "", Name: "", FactionID: passport.RedMountainFactionID, CollectionID: supremacyCollection.ID, Description: "Vintage", UsdCentCost: 100000, AmountAvailable: 500, SoldBefore: time.Date(2022, 03, 01, 0, 0, 0, 0, time.UTC), Attributes: []*passport.Attribute{{TraitType: "Brand", Value: "Red Mountain"}, {TraitType: "Model", Value: "Olympus Mons LY07"}, {TraitType: "SubModel", Value: "Vintage"}, {TraitType: "Rarity", Value: "Mega"}, {TraitType: "Asset Type", Value: "War Machine"}, {TraitType: "Max Structure Hit Points", Value: 1000, DisplayType: passport.Number}, {TraitType: "Max Shield Hit Points", Value: 1000, DisplayType: passport.Number}}},
		...
		{Restriction: "", Name: "", FactionID: passport.RedMountainFactionID, CollectionID: supremacyCollection.ID, Description: "Navy", UsdCentCost: 100000, AmountAvailable: 500, SoldBefore: time.Date(2022, 03, 01, 0, 0, 0, 0, time.UTC), Attributes: []*passport.Attribute{{TraitType: "Brand", Value: "Red Mountain"}, {TraitType: "Model", Value: "Olympus Mons LY07"}, {TraitType: "SubModel", Value: "Navy"}, {TraitType: "Rarity", Value: "Mega"}, {TraitType: "Asset Type", Value: "War Machine"}, {TraitType: "Max Structure Hit Points", Value: 1000, DisplayType: passport.Number}, {TraitType: "Max Shield Hit Points", Value: 1000, DisplayType: passport.Number}}},
