...
func OrganisationGet(ctx context.Context, conn Conn, organisationID types.OrganisationID) (*types.Organisation, error) {
...
func OrganisationGetBySlug(ctx context.Context, conn Conn, slug string) (*types.Organisation, error) {
	organisation := &types.Organisation{}
	q := `--sql
		SELECT id, slug, name, deleted_at, updated_at, created_at
		FROM organisations
...
func OrganisationCreate(ctx context.Context, conn Conn, organisation *types.Organisation) error {
...
func OrganisationUpdate(ctx context.Context, conn Conn, organisation *types.Organisation) error {
	slug := slug.Make(organisation.Name)
	q := `--sql
...
func OrganisationArchiveUpdate(ctx context.Context, conn Conn, id types.OrganisationID, archived bool) error {
