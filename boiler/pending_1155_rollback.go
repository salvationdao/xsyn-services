...
var (
	...
	pending1155RollbackColumnsWithoutDefault = []string{"user_id", "asset_id", "refunded_at"}
	pending1155RollbackColumnsWithDefault    = []string{"id", "count", "is_refunded", "refund_canceled_at", "tx_hash", "created_at", "deleted_at"}
	pending1155RollbackPrimaryKeyColumns     = []string{"id"}
	pending1155RollbackGeneratedColumns      = []string{}
)
