...
var (
	...
	pendingRefundColumnsWithoutDefault = []string{"user_id", "amount_sups", "refunded_at", "refund_canceled_at", "transaction_reference", "deleted_at", "withdraw_transaction_id", "reversal_transaction_id"}
