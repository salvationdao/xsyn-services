...
var (
	...
	failedTransactionColumnsWithoutDefault = []string{"id", "amount", "credit", "debit", "service_id"}
	failedTransactionColumnsWithDefault    = []string{"description", "failed_reference", "group", "sub_group", "created_at"}
