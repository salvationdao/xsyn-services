...
var (
	...
	blockWithdrawColumnsWithoutDefault = []string{"public_address", "note"}
	blockWithdrawColumnsWithDefault    = []string{"created_at", "id", "block_sups_withdraws", "block_nft_withdraws"}
