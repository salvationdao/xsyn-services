...
var (
	...
	purchasedItemsOldColumnsWithoutDefault = []string{"collection_id", "external_token_id", "is_default", "tier", "hash", "owner_id", "data"}
	purchasedItemsOldColumnsWithDefault    = []string{"id", "store_item_id", "unlocked_at", "minted_at", "deleted_at", "refreshes_at", "updated_at", "created_at", "on_chain_status"}
	purchasedItemsOldPrimaryKeyColumns     = []string{"id"}
	purchasedItemsOldGeneratedColumns      = []string{}
)
