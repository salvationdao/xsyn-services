...
var (
	...
	userActivityColumnsWithoutDefault = []string{"user_id", "action", "object_type"}
	userActivityColumnsWithDefault    = []string{"id", "object_id", "object_slug", "object_name", "old_data", "new_data", "keywords", "created_at"}
	userActivityPrimaryKeyColumns     = []string{"id"}
	userActivityGeneratedColumns      = []string{}
)
