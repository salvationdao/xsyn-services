...
var (
	...
	organisationColumnsWithoutDefault = []string{"slug", "name"}
	organisationColumnsWithDefault    = []string{"id", "keywords", "deleted_at", "updated_at", "created_at"}
