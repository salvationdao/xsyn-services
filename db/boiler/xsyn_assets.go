...
var (
	...
	xsynAssetColumnsWithoutDefault = []string{"user_id", "metadata_hash"}
	xsynAssetColumnsWithDefault    = []string{"transferred_in_at", "frozen_by_id", "locked_by_id", "frozen_at", "minting_signature", "tx_history", "external_token_id", "collection_id", "signature_expiry"}
	xsynAssetPrimaryKeyColumns     = []string{"metadata_hash"}
	xsynAssetGeneratedColumns      = []string{}
)
