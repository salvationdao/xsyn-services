...
var (
	...
	xsynMetadatumColumnsWithoutDefault = []string{"name", "collection_id", "hash"}
	xsynMetadatumColumnsWithDefault    = []string{"game_object", "description", "external_url", "image", "animation_url", "durability", "attributes", "additional_metadata", "keywords", "deleted_at", "updated_at", "created_at", "minted", "external_token_id", "image_avatar"}
	xsynMetadatumPrimaryKeyColumns     = []string{"hash"}
	xsynMetadatumGeneratedColumns      = []string{}
)
