...
var (
	...
	purchasedItemColumnsWithoutDefault = []string{"collection_id", "store_item_id", "external_token_id", "is_default", "tier", "hash", "owner_id", "data"}
	purchasedItemColumnsWithDefault    = []string{"id", "unlocked_at", "minted_at", "deleted_at", "refreshes_at", "updated_at", "created_at", "on_chain_status"}
	purchasedItemPrimaryKeyColumns     = []string{"id"}
	purchasedItemGeneratedColumns      = []string{}
)
