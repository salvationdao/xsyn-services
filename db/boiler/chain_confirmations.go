...
var (
	...
	chainConfirmationColumnsWithoutDefault = []string{"tx", "block", "chain_id"}
	chainConfirmationColumnsWithDefault    = []string{"tx_id", "confirmed_at", "deleted_at", "created_at", "confirmation_amount"}
	chainConfirmationPrimaryKeyColumns     = []string{"tx"}
	chainConfirmationGeneratedColumns      = []string{}
)
