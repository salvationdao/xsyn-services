...
var ProductWhere = struct {
	...
	ImageID:     whereHelpernull_String{field: "\"products\".\"image_id\""},
	Name:        whereHelperstring{field: "\"products\".\"name\""},
	Description: whereHelperstring{field: "\"products\".\"description\""},
	Keywords:    whereHelpernull_String{field: "\"products\".\"keywords\""},
...
var (
	productAllColumns            = []string{"id", "slug", "image_id", "name", "description", "keywords", "deleted_at", "updated_at", "created_at"}
	productColumnsWithoutDefault = []string{"slug", "image_id", "name", "description", "keywords", "deleted_at"}
	productColumnsWithDefault    = []string{"id", "updated_at", "created_at"}
...
func (q productQuery) One(exec boil.Executor) (*Product, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: failed to execute a one query for products")
	}
...
func (q productQuery) All(exec boil.Executor) (ProductSlice, error) {
	...
	err := q.Bind(nil, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "boiler: failed to assign all query results to Product slice")
	}
...
func (q productQuery) Count(exec boil.Executor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to count products rows")
	}
...
func (q productQuery) Exists(exec boil.Executor) (bool, error) {
	...
	err := q.Query.QueryRow(exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "boiler: failed to check if products exists")
	}
...
func (o *Product) Image(mods ...qm.QueryMod) blobQuery {
...
func (productL) LoadImage(e boil.Executor, singular bool, maybeProduct interface{}, mods queries.Applicator) error {
	var slice []*Product
	var object *Product
	...
	if singular {
		...
		foreign.R.ImageProducts = append(foreign.R.ImageProducts, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.ImageID, foreign.ID) {
				...
				foreign.R.ImageProducts = append(foreign.R.ImageProducts, local)
				break
			}
		}
	}
...
// SetImage of the product to the related item.
// Sets o.R.Image to related.
// Adds o to related.R.ImageProducts.
func (o *Product) SetImage(exec boil.Executor, insert bool, related *Blob) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &blobR{
			ImageProducts: ProductSlice{o},
		}
	} else {
		related.R.ImageProducts = append(related.R.ImageProducts, o)
	}
...
func (o *Product) RemoveImage(exec boil.Executor, related *Blob) error {
	var err error
	...
	for i, ri := range related.R.ImageProducts {
		if queries.Equal(o.ImageID, ri.ImageID) {
			continue
		}

		ln := len(related.R.ImageProducts)
		if ln > 1 && i < ln-1 {
			related.R.ImageProducts[i] = related.R.ImageProducts[ln-1]
		}
		related.R.ImageProducts = related.R.ImageProducts[:ln-1]
		break
	}
	return nil
}
...
func FindProduct(exec boil.Executor, iD string, selectCols ...string) (*Product, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "boiler: unable to select from products")
	}

	if err = productObj.doAfterSelectHooks(exec); err != nil {
...
func (o *Product) Insert(exec boil.Executor, columns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no products provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to insert into products")
	}
...
func (o *Product) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("boiler: unable to update products, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update products row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by update for products")
	}
...
func (q productQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all for products")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected for products")
	}
...
func (o ProductSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to update all in product slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to retrieve rows affected all in update all product")
	}
	return rowsAff, nil
}
...
func (o *Product) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("boiler: no products provided for upsert")
	}
	currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("boiler: unable to upsert products, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to upsert products")
	}
...
func (o *Product) Delete(exec boil.Executor, hardDelete bool) (int64, error) {
	if o == nil {
		return 0, errors.New("boiler: no Product provided for delete")
	}
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete from products")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by delete for products")
	}
...
func (q productQuery) DeleteAll(exec boil.Executor, hardDelete bool) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("boiler: no productQuery provided for delete all")
	}
	...
	result, err := q.Query.Exec(exec)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from products")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "boiler: failed to get rows affected by deleteall for products")
	}
...
func (o ProductSlice) DeleteAll(exec boil.Executor, hardDelete bool) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "boiler: unable to delete all from product slice")
	}
...
func (o *ProductSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "boiler: unable to reload all in ProductSlice")
	}
...
func ProductExists(exec boil.Executor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "boiler: unable to check if products exists")
	}
