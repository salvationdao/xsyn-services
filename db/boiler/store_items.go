...
var (
	...
	storeItemColumnsWithoutDefault = []string{"collection_id", "faction_id", "usd_cent_cost", "amount_sold", "amount_available", "restriction_group", "is_default", "tier", "data"}
	storeItemColumnsWithDefault    = []string{"id", "deleted_at", "refreshes_at", "updated_at", "created_at"}
	storeItemPrimaryKeyColumns     = []string{"id"}
	storeItemGeneratedColumns      = []string{}
)
