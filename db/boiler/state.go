...
var (
	...
	stateColumnsWithoutDefault = []string{"sup_to_usd"}
	stateColumnsWithDefault    = []string{"latest_eth_block", "latest_bsc_block", "eth_to_usd", "bnb_to_usd", "latest_block_eth_testnet", "latest_block_bsc_testnet", "id", "withdraw_start_at", "cliff_end_at", "drip_start_at"}
