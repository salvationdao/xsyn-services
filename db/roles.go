...
func RoleGet(ctx context.Context, conn Conn, roleID passport.RoleID) (*passport.Role, error) {
	role := &passport.Role{}
	q := `--sql
...
func RoleByName(ctx context.Context, conn Conn, name string) (*passport.Role, error) {
	role := &passport.Role{}
	q := `--sql
		SELECT id, name, permissions, tier, reserved, deleted_at, updated_at, created_at
		FROM roles
...
func RoleCreate(ctx context.Context, conn Conn, role *passport.Role) error {
	q := `--sql
...
func RoleCreateReserved(ctx context.Context, conn Conn, role *passport.Role) error {
	q := `--sql
...
func RoleUpdate(ctx context.Context, conn Conn, role *passport.Role) error {
	q := `--sql
		UPDATE roles
		SET 
...
func RoleArchiveUpdate(ctx context.Context, conn Conn, id passport.RoleID, archived bool) error {
