...
WITH item as (
    SELECT ('{'||pos-1||',"value"}')::text[] as path
...
FROM item
WHERE xsyn_metadata.attributes @> '[{"trait_type": "Rarity", "value": "Colossal"}]' -- rarity we want to update
...
FROM item
WHERE xsyn_metadata.attributes @> '[{"trait_type": "Rarity", "value": "Rare"}]' -- rarity we want to update
AND xsyn_metadata.attributes @> '[{"trait_type": "Brand", "value": "Red Mountain"}]' -- mech brand to update
AND xsyn_metadata.attributes @> '[{"value": "Olympus Mons LY07", "trait_type": "Model"}]'; -- mech model to update
...
FROM item
WHERE xsyn_metadata.attributes @> '[{"trait_type": "Rarity", "value": "Legendary"}]' -- rarity we want to update
AND xsyn_metadata.attributes @> '[{"trait_type": "Brand", "value": "Red Mountain"}]' -- mech brand to update
AND xsyn_metadata.attributes @> '[{"value": "Olympus Mons LY07", "trait_type": "Model"}]'; -- mech model to update
...
FROM item
WHERE xsyn_metadata.attributes @> '[{"trait_type": "Rarity", "value": "Elite Legendary"}]' -- rarity we want to update
AND xsyn_metadata.attributes @> '[{"trait_type": "Brand", "value": "Red Mountain"}]' -- mech brand to update
AND xsyn_metadata.attributes @> '[{"value": "Olympus Mons LY07", "trait_type": "Model"}]'; -- mech model to update
...
FROM item
WHERE xsyn_metadata.attributes @> '[{"trait_type": "Rarity", "value": "Ultra Rare"}]' -- rarity we want to update
  AND xsyn_metadata.attributes @> '[{"trait_type": "Brand", "value": "Red Mountain"}]' -- mech brand to update
AND xsyn_metadata.attributes @> '[{"value": "Olympus Mons LY07", "trait_type": "Model"}]'; -- mech model to update
...
SET attributes = JSONB_SET(attributes, item.path, '1650', FALSE)
FROM item
WHERE xsyn_metadata.attributes @> '[{"trait_type": "Rarity", "value": "Exotic"}]' -- rarity we want to update
  AND xsyn_metadata.attributes @> '[{"trait_type": "Brand", "value": "Red Mountain"}]' -- mech brand to update
AND xsyn_metadata.attributes @> '[{"value": "Olympus Mons LY07", "trait_type": "Model"}]'; -- mech model to update
...
FROM item
WHERE xsyn_metadata.attributes @> '[{"trait_type": "Rarity", "value": "Guardian"}]' -- rarity we want to update
  AND xsyn_metadata.attributes @> '[{"trait_type": "Brand", "value": "Red Mountain"}]' -- mech brand to update
AND xsyn_metadata.attributes @> '[{"value": "Olympus Mons LY07", "trait_type": "Model"}]'; -- mech model to update
...
FROM item
WHERE xsyn_metadata.attributes @> '[{"trait_type": "Rarity", "value": "Mythic"}]' -- rarity we want to update
  AND xsyn_metadata.attributes @> '[{"trait_type": "Brand", "value": "Red Mountain"}]' -- mech brand to update
AND xsyn_metadata.attributes @> '[{"value": "Olympus Mons LY07", "trait_type": "Model"}]'; -- mech model to update
...
FROM item
WHERE xsyn_metadata.attributes @> '[{"trait_type": "Rarity", "value": "Deus ex"}]' -- rarity we want to update
AND xsyn_metadata.attributes @> '[{"trait_type": "Brand", "value": "Red Mountain"}]' -- mech brand to update
AND xsyn_metadata.attributes @> '[{"value": "Olympus Mons LY07", "trait_type": "Model"}]'; -- mech model to update
