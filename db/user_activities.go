...
func UserActivityGet(ctx context.Context, conn Conn, result *passport.UserActivity, id passport.UserActivityID) error {
	q := `
...
func UserActivityList(ctx context.Context, conn Conn, result *[]*passport.UserActivity, search string, filter *ListFilterRequest, page int, pageSize int, sortBy UserActivityColumn, sortDir SortByDir) (int, error) {
	// Prepare Filters
	var args []interface{}
